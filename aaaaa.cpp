...
void ekle2(Dugum** kok, string &ay, int veri, int sira){   
    Dugum* new_node=new Dugum();
    new_node->veri=veri;
    new_node->Aylar=ay;
    new_node->sonraki=*kok;
    *kok=new_node;
...
void ekle(Dugum** kok, string &ay, int veri,int sira){
    Dugum* new_node2=new Dugum();
    new_node2->veri=veri;
    new_node2->Aylar=ay;
    new_node2->sonraki=*kok;
    *kok=new_node2;
...
// void bastir(Dugum* r, Dugum *r2){
//     while(r!=NULL){
//         // printf("%s %d",r->Aylar, r->veri);
//         cout<<" "<<r->Aylar<<" "<<r->veri<<endl;
//         r=r->sonraki;
//     }
//     cout<<"     ";
//     while(r2!=NULL){
//         // printf("%s %d",r->Aylar, r->veri);
//         cout<<" "<<r2->Aylar<<" "<<r2->veri<<endl;
//         r2=r2->sonraki;
//     }
// }

void karsilastir(Dugum* r3, int sayi, int a){
    int tut=1285;
    int tut2=19206;
        for(int i=0;i<8;i++){
        if(sayi+1==r3->sira){
            
            //cout<<r3->veri<<"   "<<r3->Aylar;
            if(r3->veri > tut){
...
void karsilastir2(Dugum* r3, int sayi, int a){
    int tut=19206;
        for(int i=0;i<8;i++){
        if(sayi+1==r3->sira){
